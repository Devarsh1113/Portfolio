  ...
  return (
    <div className="border-b border-neutral-900 pb-4 lg:mb-35">
        <div className="flex flex-wrap">
            ...
            <h1 className="text-6xl pb-16 font-light tracking-tight lg:mt-16 lg:text-8xl text-white">
              Devarsh Agrawal
            </h1>
            ...
            <img  className="w-auto  lg:w-auto lg:p-8"src={coding} alt="coding picture" />
            </div>
            </div>
        </div>
    </div>
